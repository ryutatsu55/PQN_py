...
def main():
    ...
    reservoir_weight_calc = reservoir_weight*temp/1000
...
def create_reservoir_matrix(N):
    ...
    while crust_idx != 4:
        ...
        reservoir_weight[i1:i2, i1:i2] = ((G * np.random.randn(N//4, N//4)) + 1) * (np.random.rand(N//4, N//4) < p)
