...
# =========================
CLASS = "RSexci"
RESULTS_PATH = f"audio_rc/results/results_{CLASS}.jsonl"
...
plt.tight_layout()
plt.savefig(f"audio_rc/figs/accuracy_bar_plot_{CLASS}.png")

results = []

# JSONL 読み込み
with open(f"audio_rc/results/results_{CLASS}.jsonl") as f:
    for line in f:
...
plt.legend()
plt.tight_layout()
plt.savefig(f"audio_rc/figs/accuracy_over_seeds_RSexci.png")
